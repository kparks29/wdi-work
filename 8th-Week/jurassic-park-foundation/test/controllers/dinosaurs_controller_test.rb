...
class DinosaursControllerTest < ActionController::TestCase
  ...
  test "should create dinosaur" do
    assert_difference('Dinosaur.count') do
      post :create, dinosaur: { description: @dinosaur.description, diet: @dinosaur.diet, name: @dinosaur.name, other_name: @dinosaur.other_name }
    end
  ...
  test "should update dinosaur" do
    patch :update, id: @dinosaur, dinosaur: { description: @dinosaur.description, diet: @dinosaur.diet, name: @dinosaur.name, other_name: @dinosaur.other_name }
    assert_redirected_to dinosaur_path(assigns(:dinosaur))
  end
